...
Finally, let us address probably one of the most important points when working with statistics in science: how to get the data you have collected into your R environment. For this part of the lesson, we will be working with the bandersnatch.csv file (created by Katie Long) located here: https://drive.google.com/open?id=1A5kcC2CCfl9pGL0_jn7kgO6Mp3T8rSNIQp7wbt49vXo.

```{r read write}
data <- read.csv("./data/bandersnatch.csv")
```
