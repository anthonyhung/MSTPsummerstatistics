...
Students should propose a topic for their presentation and send the proposed topic to the instructors via email by the 7th week of classes. A rubric for the presentation can be found [here](https://drive.google.com/open?id=1FPfHFjK83qjQQmMX4uLujx9von8jRZlB).
...
Week 2: Bayesian inference; Review of basic statistical tests

Week 3: Review of basic statistical tests continued; Regression

Week 4: Mutliple Testing; Power Analyses
